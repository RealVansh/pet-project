...
export const metadata: Metadata = {
  ...
  description: 'Learn about our 5+ years of experience delivering premium pet care services including grooming, training, and walking.',
};
      ...
      <section className="bg-forest-900 pt-32 pb-16 lg:pt-40 lg:pb-20">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">
            About <span className="text-brass-500">Bark & Bond</span>
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <AnimatedSection delay={100} className="bg-white p-10 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 border border-taupe-200 group">
              ...
              <p className="text-taupe-600 leading-relaxed">
                A proven track record of delivering reliable, premium pet care services that you can trust implicitly.
              </p>
            </AnimatedSection>
